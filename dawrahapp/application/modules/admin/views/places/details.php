												...
												<div class="portlet box blue ">
													...
													<div class="portlet light bordered form-fit">
														<div class="portlet-body form">
															...
															<form action="<?php echo $url?>admin/places/edit_action" class="form-horizontal form-bordered"
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">الدولة</span>
																			<input name="title" id="title" value="<?=$services_type->title;?>" type="text" placeholder="الدولة" class="form-control" required>
