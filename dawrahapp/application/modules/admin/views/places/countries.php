							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الدول</span>
									</div>
								</div>
								<span class="portlet-body">
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												<?php if($result_amount>0){
													...
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إضافة دولة
									...
									<form action="<?=$url?>admin/places/delete" method="POST" id="form">
									<div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/places/details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/places/delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/add");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/delete");
	});
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/places/check_view_countries") ?>',
                type: 'POST',
                data: data,				
