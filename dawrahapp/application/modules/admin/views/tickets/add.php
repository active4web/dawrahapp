															 ...
															 method="post">
																<div class="form-body">
																	<div class="form-group">
																		...
																		<div class="col-md-10">
																			<input name="name_ar" type="text" placeholder="الإسم عربي" class="form-control" required>
																	...
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-10">
																			<input name="name_en" type="text" placeholder="الإسم إنجليزي" class="form-control" required>
																			<span class="help-block"> الإسم إنجليزي </span>
																		</div>
																	</div>
