			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span href="<?=$url.'admin';?>">موديولات</span>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span class="active">العملاء المفعلين</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">العملاء المفعلين</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/mazadat/delete" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
											...
											//print_r($data->id);
											//$subscribers = get_table_2('mazad_subscribers',['customer_id'=>$data->id],'','mazad_id');
											$where['customer_id'] = $data->id;
											$subscribers = $this->db->select('mazad_id as mazadid')
													->group_by('mazadid')
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/customers/details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تفاصيل </a></li>
															<li><a href="<?=$url?>admin/customers/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/customers/delete?id_mazadat=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
