			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"> اكواد الخصم</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">اكواد الخصم</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/codes/delete_code" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										<thead>
											<tr>
												...
												<th>اجمالى الاستخدام </th>
											    <th>مرات الاستخدام للفرد الواحد </th>
											    	<th> حالة الكود </th>
												<th> الحالة </th>
												<th> العمليات </th>
											</tr>
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												if($data->end_date>=date("Y-m-d")){
												     $code_type="<span class='label label-sm label-danger'>الكود يعمل الان</span>";
												     $main_data['case_type']=0;
												}
												else{
												    $code_type="<span class='label label-sm label-danger'>الكود منتهى</span>";
												    $main_data['case_type']=1;
												}

												$this->db->update("codes",$main_data,array());
									   ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/codes/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/codes/delete_code?id_pages=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/codes/active") ?>',
		type: 'POST',
		data: data,				
