			...
			<div class="tab-pane active" id="tab_5">
				<div class="portlet box blue ">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>تعديل حالة مهمة</div>
					</div>
							...
							<input type="hidden" name="id" value="<?=$data->id;?>">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
										<span class="help-block">حالة المهمة</span>
		    <?php $status=get_table_filed("tbl_tasks",array("id"=>$this->input->get('id_status')),"status");?>
		    
		<input type="radio"  <?php 	if($status==1||$status==2){?>disabled<?php }?>  class="form-control" style="height:22px;" name="status" value="0" > لم تبدا   
		<input type="radio"  <?php 	if($status==1||$status==2){?>disabled<?php }?> class="form-control" style="height:22px;" name="status" value="1" checked>جارى العمل عليها
		<input type="radio" <?php 	if($status==0||$status==2){?>disabled<?php }?> class="form-control main_title" style="height:22px;" name="status" value="2" >تم الانتهاء منها
										</div>
										<div class="col-md-1"></div>
									</div>
