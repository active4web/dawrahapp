...
$curt='courses';
 ...
 $course_name=get_table_filed('products',array('id'=>$id),"name");
}
?>
<!DOCTYPE html>
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<li>
					    <a href="<?=$url.'admin/courses/inside';?>">
							<span class="">الدورات </span>
							
							</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span class="active">التقييمات </span>
							<i class="fa fa-circle"></i>
						</li>
							<li>
							<span class="active"><?=$course_name;?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">التقييمات</span>
									</div>
								...
								<span class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										$user_name=get_table_filed('customers',array('id'=>$user_id),"user_name");
												...
												$intersted_courses=$this->db->get_where("reviews",array("id_course"=>$data->id))->result();
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td> <?=$data->rate;?> </td>
												<td> <?=mb_substr($data->comment,0,120);?> </td>
												<td><a href="<?=$url?>admin/users/customers_details?id=<?=$data->id;?>"><i class="fa fa-eye"></i>  <?=$user_name;?></a> </td>
