											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i>اضافة حقيبة </div>
													</div>
													<?php //print_r($now);?>
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> اسم الحقيبة </span>
																			<input name="title" id="title"  type="text" placeholder="اسم الحقيبة " class="form-control" required>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">اجمالى الساعات</span>
																			<input name="bage_hrs" id="bage_hrs"  type="number" placeholder="اجمالى الساعات" class="form-control" required>
																		</div>
																	</div>	
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">إجمالى الايام فى الاسبوع</span>
																			<input name="week_bage_daies" id="week_bage_daies"  type="number" placeholder="اجمالى الأيام فى الأسبوع" class="form-control" required>
																		</div>
																	</div>	
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">اجمالى ايام الحقيبة</span>
																			<input name="bage_total_daies"   id="bage_total_daies" type="number" placeholder="اجمالى ايام الحقيبة" class="form-control" required>
																		</div>
																	</div>	
                                                             ...
                                                             <?php }?>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">الوصف العام للحقيبة</span>
																			<textarea name="bage_details" id="bage_details" class="form-control" style="height:80px"></textarea>
																		</div>
																	</div>
