...
<head>
<meta charset="utf-8">
<title>المحتوى الداخلى للدورات</title>
...
<i class="fa fa-circle"></i>
						...
						<li>
							<span class="active"> محتوى الدورات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">محتوى الدورات </span>
									</div>
...
<ul class="ss"></ul>
								...
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/courses/delete_content" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=mb_substr($data->content,0,50);?> </td>
												<td>	<a  data-id="<?php echo $data->id;?>" class="btn btn-xs purple table-icon edit" title="change status" style="padding: 1px 0px;">
												...
												<td>
													<div class="btn-group">
														...
														<li><a href="<?=$url?>admin/courses/edit_content?id=<?=$data->id;?>&course_id=<?= $_GET['course_id']?>&type=2"><i class="fa fa-pencil"></i> تعديل </a></li>
													   <li><a  href="<?=$url?>admin/courses/delete_content?id=<?=$data->id;?>&course_id=<?= $_GET['course_id']?>&type=2"><i class="fa fa-remove"></i> حذف </a>
...
$(document).ready(function(e) {
	$(".delbutton").click(function(e) {
	 ...
	 $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/courses/add_course_content?course_id=<?= $_GET['course_id']?>&type=2");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/courses/active_content") ?>',
                type: 'POST',
                data: data,				
