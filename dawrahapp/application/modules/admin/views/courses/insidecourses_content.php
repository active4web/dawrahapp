											...
											<tr class="odd gradeX">
												...
												<td>
													<div class="btn-group">
														...
														<li><a href="<?=$url?>admin/courses/edit_content?id=<?=$data->id;?>&course_id=<?= $_GET['course_id']?>&type=1"><i class="fa fa-pencil"></i> تعديل </a></li>
													   <li><a  href="<?=$url?>admin/courses/delete_content?id=<?=$data->id;?>&course_id=<?= $_GET['course_id']?>&type=1"><i class="fa fa-remove"></i> حذف </a>
...
$(document).ready(function(e) {
	$(".delbutton").click(function(e) {
	 ...
	 $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/courses/add_course_content?course_id=<?= $_GET['course_id']?>&type=1");
    });
});
</script>
