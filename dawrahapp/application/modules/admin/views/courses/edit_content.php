			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<div class="row">
						...
						<form action="<?= base_url()?>admin/courses/edit_content_action" class="form-horizontal form-bordered"  method="post" id="myForm">
							<input name="id" value="<?= $data->id;?>" type="hidden"  >									    
								<input name="course_id" value="<?= $_GET['course_id'];?>" type="hidden"  >	
									<input name="type" value="<?= $_GET['type'];?>" type="hidden"  >	
										...
										<textarea name="content"  class="form-control" style="height:40px"><?= $data->content?></textarea>
																		</div>
																	</div>
