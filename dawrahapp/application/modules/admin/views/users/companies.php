							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الشركات </span>
									</div>
								</div>
									...
									$country_name=	get_table_filed('country',array('id'=>$country_id),"title");
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$city_name;?> </td>
												<td> <?=$country_name;?> </td>
												<td><a href="<?= base_url()?>users/company_details?id=<?= $data->id;?>"><?= count($intersted_courses);?></a> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/users/company_details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تفاصيل </a></li>
