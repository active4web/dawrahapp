...
<head>
<meta charset="utf-8">
<title>تفاصيل مقدم الحقيبة</title>
			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/users/bags_provider/';?>">مقدمى الحقائب</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span class="active">تفاصيل مقدم الحقيبة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i> تفاصيل مقدمى الحقائب </div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-10">
																			...
																			<div class="portlet box yellow">
																				<div class="portlet-title">
																					<div class="caption">
																						<i class="fa fa-gift"></i> تفاصيل مقدم الحقيبة </div>
																					<div class="tools">
																										...
																										<div class="table-responsive">
																											<table class="table table-bordered">
																												<tbody>
                                                                                                                	...
                                                                                                                	<tr>
																														<th>اجمالى الحقائب المضافة</th>
																														<td><a href="<?= base_url()?>admin/users/bages?user_id=<?= $id?>"> <?=count($bag_info);?> </td>
																													</tr>
