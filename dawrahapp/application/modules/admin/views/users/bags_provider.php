			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">مقدم الحقائب </span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">مقدم الحقائب </span>
									</div>
								</div>
								<span class="portlet-body">
									...
									$country_name=	get_table_filed('country',array('id'=>$country_id),"title");
										...
										$total_bages=$this->db->get_where("bag_info",array("user_id"=>$data->id))->result();
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td> <?=$city_name;?> </td>
												<td> <?=$country_name;?> </td>
												<td> <a href="<?= base_url()?>users/provider_details?user_id=<?=$data->id?>"><?=count($total_bages);?> </a></td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/users/provider_details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تفاصيل </a></li>
