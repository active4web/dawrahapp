			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/users/companies/';?>">الشركات</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span class="active">تفاصيل الشركة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
								...
								<div class="row">
									<div class="col-md-12">
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i> تفاصيل الشركة </div>
								    	...
								    	$country_name=	get_table_filed('country',array('id'=>$country_id),"title");
													...
													$request_courses=$this->db->get_where("request_courses",array("id_user"=>$result->id))->result();
														?>
																									...
																									<div class="portlet-body">
																										<div class="table-responsive">
																											...
																											<?php 
																												...
																												<tr><td colspan="2" style="text-align:center"> الاهتمامات</td></tr>	
																										  <?php 
																										  foreach($intersted_courses as $intersted_courses){
																										   $department_id= $intersted_courses->department_id;
																										   	$category_name=	get_table_filed('category',array('id'=>$department_id),"name");
																													?>
																														<tr>
