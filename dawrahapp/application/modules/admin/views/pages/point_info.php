							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الصفحات</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/pages/delete_points_terms" method="POST" id="form">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/pages/edit_points_terms?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/pages/delete_points_terms?id_pages=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("add_points_terms");
    });
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/pages/active") ?>',
		type: 'POST',
		data: data,				
