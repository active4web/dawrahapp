						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/pages/delete" method="POST" id="form">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/pages/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/pages/delete?id_pages=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
