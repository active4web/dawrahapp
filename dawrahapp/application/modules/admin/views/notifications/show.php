			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">تنبيهات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
								...
								<span class="portlet-body">
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إرسال
									...
									<form action="<?=$url?>admin/notifications/delete" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
                                            foreach($results as $data) {
                                                $type=$data->type;
                                                	switch($type){
													case 1:
													  $type="<span class='label label-sm label-danger'>دورات</span>";
													  break;
													case 2:
													  $type="<span class='label label-sm label-success'>الأدارة</span>";
													  break;
													  case 3:
													  $type="<span class='label label-sm label-danger'>اضافة نقاط</span>";
													  break;
													  case 4:
													  $type="<span class='label label-sm label-success'>تذاكر</span>";
													  break;
													default:
													  break; 
												}
										...
										$course_name="";
											...
											if($course_key==2){
											$course_name=get_table_filed('bag_info',array('id'=>$course_id),"bage_name");
											}
											else {
											  	$course_name=get_table_filed('products',array('id'=>$course_id),"name");  
											}
                                        ?>
											<tr class="odd gradeX">
												<td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/notifications/details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تفاصيل </a></li>
															<li><a href="<?=$url?>admin/notifications/delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
