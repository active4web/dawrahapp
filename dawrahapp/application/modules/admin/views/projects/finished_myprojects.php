			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">المشاريع المنتهية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"> المشاريع المنتهية</span>
									</div>
								</div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?=$url?>admin/projects/files?project_id=3&id_project=<?=$data->id;?>">
															<i class="fa fa-file-pdf-o"></i> الملفات </a></li>
															<li><a href="<?=$url?>admin/projects/details?project_id=3&id_project=<?=$data->id;?>">
															<i class="fa fa-eye"></i> تفاصيل </a></li>
															<?php
														if($this->session->userdata('projects_edit')=="projects_edit"){
														?>
														<li><a href="<?=$url?>admin/projects/edit?project_id=3&id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
														<?php
														}
													 if($data->status!=4) {
														...
														if($this->session->userdata('projects_delete')=="projects_delete"){
														?>
															<li><a href="<?=$url?>admin/projects/delete?project_id=3&id_projects=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
														<?php 
														}
														}
														if($this->session->userdata('project_status')=="project_status"){
														?>
														<li><a href="<?=$url?>admin/projects/project_status?project_id=3&id_projects=<?=$data->id;?>"><i class="fa fa-pencil"></i>  حالة المشروع </a></li>
														<?php 
														}
