			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">المشاريع الحالية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"> المشاريع الحالية</span>
									</div>
								</div>
								<span class="portlet-body">
										...
										<div class="row">
											<div class="col-md-12">
												<?php if($result_amount>0){
													...
													?>
													<div class="btn-group">
														<button id="sample_editable_1_2_new" class="btn sbold red delbutton_project"> حذف مجموعة
                                  ...
                                  foreach($results as $pdata) {
                                      $id_project=$pdata->id_projects;
          $current_myproject=$this->db->get_where("tbl_projects",array("id"=>$id_project))->result();
          foreach($current_myproject as $data)
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$data->code;?> </td>
												<td><a href="<?=DIR?>admin/task/tasks?id_project=<?=$data->id;?>"> <?=$data->name;?> </a></td>
												<td> <?=$status;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?=$url?>admin/projects/files?project_id=2&id_project=<?=$data->id;?>">
															<i class="fa fa-file-pdf-o"></i> الملفات </a></li>
															<li><a href="<?=$url?>admin/projects/details?project_id=2&id_project=<?=$data->id;?>">
															<i class="fa fa-eye"></i> تفاصيل </a></li>
															<?php
														if($this->session->userdata('projects_edit')=="projects_edit"){
														?>
														<li><a href="<?=$url?>admin/projects/edit?project_id=2&id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
														<?php
														}
													 if($data->status!=4) {
														...
														if($this->session->userdata('projects_delete')=="projects_delete"){
														?>
															<li><a href="<?=$url?>admin/projects/delete?project_id=2&id_projects=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
														<?php 
														}
														}
														if($this->session->userdata('project_status')=="project_status"){
														?>
														<li><a href="<?=$url?>admin/projects/project_status?project_id=2&id_projects=<?=$data->id;?>"><i class="fa fa-pencil"></i>  حالة المشروع </a></li>
														<?php 
														}
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/projects/add?project_id=2");
    });
