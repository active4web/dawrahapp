			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"> المشاريع المنتظرة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"> المشاريع المنتظرة</span>
									</div>
								</div>
											...
											<tr class="odd gradeX">
												...
												<td>
													<div class="btn-group">
														...
														?>
														<li><a href="<?=$url?>admin/projects/edit?project_id=1&id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
														<?php
														}
													 if($data->status!=4) {
														...
														if($this->session->userdata('projects_delete')=="projects_delete"){
														?>
															<li><a href="<?=$url?>admin/projects/delete?project_id=1&id_projects=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
														<?php 
														}
														}
														if($this->session->userdata('project_status')=="project_status"){
														?>
														<li><a href="<?=$url?>admin/projects/project_status?project_id=1&id_projects=<?=$data->id;?>"><i class="fa fa-pencil"></i>  حالة المشروع </a></li>
														<?php 
														}
