																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> اسم المشروع</span>
																			...
																			<input name="name_project" id="mainid" type="text" value="<?=$data->name?>" placeholder="اسم المشروع" class="form-control" required>
																		</div>
																		<div class="col-md-1"></div>
																	</div>
...
<?php }?>
 style="direction: ltr;width: 100%; <?php if($data->select_date==1){?> display:none <?php }?>" size="18" id="meeting_start" type="text"  class="form_datetime form-control editable editable-click" >																		</div>
																		<div class="col-md-1"></div>
																	</div>
															...
															<!---	<div class="form-group">
																	<div class="col-md-1"></div>
																		...
																		<option value="">حدد حالة المشروع</option>
																...
																<div class="form-group">
																			<div class="col-md-1"></div>
																			<div class="col-md-10">
																			<span class="help-block">حالة المشروع
																			<Span><?php
																			$status=$data->status	;
																			switch($status){
																				case 1:
						...
						<input type="checkbox" class="typeproject" name="services_type[]" value="<?=$services_type->id;?>" <?php if(in_array($services_type->id,$type_id)){?>
																			...
																			<div class="form-group">
																				<div class="col-md-1"></div>
																				<div class="col-md-10">
																				<span class="help-block">مدير المشروع
															...
															<?php
																...
																<!--	<div class="form-group">
																		...
																		<span class="help-block">اسم العميل</span>
																			...
																			<input name="client_name" type="text"  value="<?=$data->clients_name?>" placeholder=" اسم العميل" class="form-control" >
																		</div>
																		<div class="col-md-1"></div>
																	</div>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> رقم جوال العميل</span>
																			...
																			<input name="client_phone" type="text" value="<?=$data->clients_phone?>" placeholder=" رقم جوال العميل" class="form-control" >
																		</div>
																		<div class="col-md-1"></div>
																	</div>--->
