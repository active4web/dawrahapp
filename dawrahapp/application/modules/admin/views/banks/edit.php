			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/banks/payment_type/';?>">انواع التحويلات</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
													...
													<div class="portlet light bordered form-fit">
														...
														<?php
															foreach($data as $result){
																$id = $result->id;
																$title_ar = $result->name;
															
															}
														?>
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $url?>admin/banks/edit_action" class="form-horizontal form-bordered"
																...
																<div class="form-body">
																	<div class="form-group">
																		...
																		<div class="col-md-10">
																			...
																			<input value="<?=$title_ar;?>" name="title" type="text" placeholder="عنوان  " class="form-control" required>
