			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الحسابات البنكية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الحسابات البنكية</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/banks/delete_bank_accounts" method="POST" id="form">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/banks/edit_bank_accounts?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/banks/delete_bank_accounts?id_pages=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("add_bank_accounts");
    });
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/banks/active_banks") ?>',
		type: 'POST',
		data: data,				
