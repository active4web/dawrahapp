			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">انواع التحويلات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">انواع التحويلات</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/banks/delete" method="POST" id="form">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/banks/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/banks/delete?id_pages=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
