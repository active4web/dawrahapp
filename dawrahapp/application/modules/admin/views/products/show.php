			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">المنتجات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/products/delete" method="POST" id="form">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/products/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/products/delete?id_products=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
