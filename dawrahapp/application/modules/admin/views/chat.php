		...
		<div class="col-md-12">
		 ...
		 if(count($list_user)>0){
							 ...
							 <a href="<?=DIR?>admin/chat/special_chat?user=<?= $value->id?>&id_project=<?=$id_project?>"> <strong class="primary-font">
			                  <li class="left clearfix">
			                     ...
			                     <div class="chat-body clearfix">
			                        <div class="header_sec"><?= $value->fname?>&nbsp<?= $value->lname?></strong>
			                        </div>
			                     </div>
			                  </li>
												</a>
						 ...
						 <div class="row">
							 ...
							 <div class="chat_area">
								 <ul id="appendchat" class="list-unstyled">
									 ...
									 $total_message=$this->db->get_where("chat",array("type"=>'1','id_project'=>$id_project))->result();
				...
				<div class="chat-body1 clearfix">
					<p class="font-else"><b><?=$fname."&nbsp&nbsp".$sname."&nbsp&nbsp".$lname?></b>:<?=$total_message->content;?></p>
				...
				<div class="chat-body1 clearfix">
					<p class="font-me"><b><?=$fname."&nbsp&nbsp".$sname."&nbsp&nbsp".$lname?></b>:<?=$total_message->content;?></p>
					<div class="chat_time pull-right"><?=$total_message->date;?></div>
				</div>
			</li>
...
var id_project=$("#id_project").val();
			...
			var data={ses_id:ses_id,message:data.message,id_project:id_project};
			$.ajax({
				url: '<?php echo base_url("admin/chat/add_mess") ?>',
                type: 'POST',
                data: data,				
