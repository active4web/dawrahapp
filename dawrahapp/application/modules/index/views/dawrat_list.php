...
<section class="page-title-bg pt-130 pb-30" >
        <div class="container">
			...
			<div class="col-md-4"></div>
                <div class="col-md-4">
					...
					<div class="row">
                        <span class="col-md-3 user_dawrat"><a href="<?= base_url()?>user/" style="color:#fff;">الدورات</a> </span>
						...
						<span class="col-md-3 user_dawrat_1"><a href="<?= base_url()?>user/trainers/">المدربين</a></span>
						</div>
                    </div>
                </div>
				<div class="col-md-4"></div>
		...
		<div class="wrapper">
			<div class="container">
				<div class="row  pt-50 ">
<div class="col-md-3" style="margin-bottom:30px;background-color:#fcfcfe;padding:10px">
<?php 
include("sidebar.php");
?>
					</div>
...
<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="th-list" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-th-list fa-w-16 fa-lg"><path fill="currentColor" d="M0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48H48C21.49 32 0 53.49 0 80zm472 224H197.333v-96H472v96zm0 40v84c0 6.627-5.373 12-12 12H197.333v-96H472zM40 208h117.333v96H40v-96zm157.333-40V72H460c6.627 0 12 5.373 12 12v84H197.333zm-40-96v96H40V84c0-6.627 5.373-12 12-12h105.333zM40 344h117.333v96H52c-6.627 0-12-5.373-12-12v-84z" class=""></path></svg>
	 ...
	 <a href="<?=base_url()?>user/courses/dawrat">
...
<?php } else {?>
	<i class="fa fa-heart no_myfav"></i>
<?php }?>
...
<h3 style="font-size:14px;text-align:right;font-weight:600;padding-top:10px;color:#797979"><?= $bag->name;?></h3>

<div class="row"  style="color:#797979;padding-top:10px">
<div class="col-md-2" style="font-weight:500;font-size:13px;text-align:right">
<i class="fa fa-map-marker" style="margin-left:5px;"></i><?= mb_substr($city,0,20);?></div>
<div class="col-md-3" style="font-size:13px;text-align:right;font-weight:500;">
<i class="fa fa-hotel" style="margin-left:5px"></i><?= mb_substr($Institute_name,0,20);?></div>
<div class="col-md-2" style="font-size:13px;text-align:right;color: #367dff;font-weight:500;">
