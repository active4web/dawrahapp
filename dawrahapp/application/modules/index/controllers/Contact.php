...
$logo=DIR."uploads/site_setting/$logo"		;	
		 ...
		 $subject = "رسالة جديدة من موقع دورة للتدريب والتعليم";
		 $mail_message= "<br>";
		 $mail_message.=
			 ...
			 <table cellspacing='0' cellpadding='0' width='600' class='w320'>
			   <tr>
				 <td style='padding:5px 0 25px' class='free-text headerlgb1'>
				   &copy; جميع الحقوق محفوظة لدى شركة <a href='https://wisyst.com/'>دورة-Dawar   </a>  <br />
				  <br /><br />
				 </td>
			   </tr>
			 </table>
...
$body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	$this->session->set_flashdata('msg',"تم ارسال رسالتك بنجاح وسوف يتم التواصل معك فى اقرب وقت ممكن");
