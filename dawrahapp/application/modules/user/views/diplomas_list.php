			...
			<div class="col-md-4"></div>
                <div class="col-md-4">
					...
					<div class="row">
						...
						<span class="col-lg-3 col-md-6 user_dawrat"><a href="<?= base_url()?>user/courses/diplomas" style="color:#fff;">الدبلومات</a></span>
...
<div class="img_info" >
<a href="<?=base_url()?>user/courses/diplomas_details/<?= $bag->id;?>">
<?php 
if($bag->img!=""){
?>
...
<input type="hidden" class="course_key" value="<?= $bag->type;?>">
  ...
  <a href="<?=base_url()?>user/courses/diplomas_details/<?= $bag->id;?>">
<h3 style="font-size:14px;text-align:right;font-weight:600;padding-top:29px;color:#797979"><?= $bag->name;?></h3></a>
  <a href="<?=base_url()?>user/courses/diplomas_details/<?= $bag->id;?>">
