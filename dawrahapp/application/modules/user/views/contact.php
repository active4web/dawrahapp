...
<section class="page-title-bg pt-120 pb-30" >
        <div class="container">
            <div class="row">
                <div class="col-12">
		...
		<div class="wrapper">
			<div class="container">
				<div class="row  pt-50 ">
					...
					<div class="col-md-6 col-sm-6 col-xs-12" style="background:#367dfe;margin-left:-10px;z-index:999;margin-bottom:30px;">
<div class="info">
    <div><br></div>
<div><i class="fas fa-map-marker-alt fa-lg info_contant"></i><?= $siteinfo->address ; ?></div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 " style="margin-right:-10px">
