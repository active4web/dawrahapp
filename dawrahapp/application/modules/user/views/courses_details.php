...
<section class="page-title-bg pt-130 pb-30" >
                ...
                <div class="col-md-7 col-lg-5">
                    <div class="page-title attr_title">
                        <ul class="list-inline">
							...
							<li><a href="<?=DIR ?>user/">الدورات</a></li>
							<li><i class="fa fa-chevron-left"></i></li>
							<li><?= $data->name;?></li>
		...
		<div class="wrapper">
			<div class="container">
				<div class="row  pt-50 ">
<div class="col-md-4 col-lg-3"  style="border:1px solid #ecebebde; border-radius:0.4em;">
...
<div class="row" style="background-color:#fff;border:1px solid #ecebebde; border-radius:0.4em;;margin:0px !important">
