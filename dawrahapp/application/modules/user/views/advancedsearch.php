			...
			<div class="container">
				<div class="row  pt-50 ">
					...
					<div class="col-lg-12 col-md-12 col-sm-12" style="">
						<div class="row" style="margin:0px;background-color: #fff;padding: 10px;border:1px solid #ecebebde; border-radius:0.4em;">
...
?>
<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 main_dwart"  style="webkit-box-shadow: 3px 1px 3px 1px #ecebebde; box-shadow: 3px 1px 3px 1px #ecebebde;padding-bottom: 10px;">
...
<div class="col-12  no_p no_p_c">
<h3 class="title_course"><?= $bag->name;?></h3>
</div>

<div class="col-12  no_p no_p_c">
    <div class="row margin_special"  style="color:#3f3f3f;">
...
<div class="col-lg-6 col-md-12 col-sm-12 no_p  no_p_c" style="font-size:12px;text-align:right;">
                                     <?php
...
<div class="col-lg-6 col-md-12 col-sm-12 align_r no_p no_p_c" style="font-size:13px;text-align:left;font-weight:400">
<?php 
...
?>
<div class="col-md-6 col-lg-3 col-sm-12 main_dwart" style="webkit-box-shadow: 3px 1px 3px 1px #ecebebde; box-shadow: 3px 1px 3px 1px #ecebebde;padding-bottom:20px;">
