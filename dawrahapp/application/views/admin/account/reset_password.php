    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php echo form_open(base_url().admin_dir() . '/account/reset_password');?>
                    ...
                    <div class="md-float-material">
                        ...
                        <div class="auth-box">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-right txt-primary">إسترجاع كلمة المرور</h3>
                                </div>
                            </div>
                            <hr/>
                            ...
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <input type="submit" name="rese_pass" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" value="ارسال" />
                                </div>
                            </div>
