...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item"><a href="#">اضافة مشروع جديد</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-block">
                    ...
                    <?php echo form_open_multipart(base_url().admin_dir() . '/projects/add');?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="dropper-default" name="delivery_date" class="form-control" type="text" value="<?= set_value('delivery_date') ?>" placeholder="Select date" readonly="readonly">
                        </div>
                    </div>
                    <?php endif;?>
                    <hr />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="notes" class="form-control" rows="3" cols="100"><?= set_value('notes') ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">
                    ...
                    <div class="form-group">
                        <div class="text-center col-xs-12">
                            <input type="submit" name="add-project" class="btn btn-success" value="حفظ" />
                        </div>
                    </div>
                    <?php echo form_close();?>
                </div>
