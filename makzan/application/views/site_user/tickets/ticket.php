 <div class="page-content mb-5">
        <div class="container">
            <div class="page-header rounded px-3 py-2 d-flex justify-content-between align-items-center">
                ...
                <a href="<?=base_url('site_user/tickets')?>" class="btn px-3 text-white">
                    إنشاء تذكرة جديده
                </a>
            </div><!-- .page-header -->
            ...
            <div class="comments mt-5">
                    ...
                    <div class="comment-box d-flex rounded px-4 py-5 mt-5">
                        ...
                        <div class="comment">
                            <h5 class="comment-title font-weight-bold">
                                <?php if($reply->reply_type == 2){ echo 'خدمة العملاء'; }else{ echo $user_data['full_name']; } ?>
                            </h5>
                ...
                <form method="POST" action="<?=base_url('site_user/tickets/reply/'.$ticket['id'])?>" class="reply-form mt-5 clearfix">
