         ...
         <div class="card-block">
            <form action="" method="POST" enctype="multipart/form-data">
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="text" class="form-control" name="title" value="<?=$slider['title']?>" placeholder="من فضلك ادخل العنوان">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="text" class="form-control" name="note" value="<?=$slider['note']?>" placeholder="من فضلك ادخل الوصف المختصر">
               ...
               <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  تعديل </button>    <a href="<?=base_url('admin_panel/slider')?>" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
            </form>
         </div>
</div>
