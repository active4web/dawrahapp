            ...
            <form action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     ...
                     <input type="text" class="form-control" name="name" value="<?=set_value('name')?>" placeholder="من فضلك ادخل اسم الدولة">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     ...
                     <input type="text" class="form-control" name="international_key" value="<?=set_value('international_key')?>" placeholder="من فضلك ادخل المفتاح الدولي ">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      ...
                      <input type="file" name="flag" value="<?=set_value('flag')?>" class="form-control">
               ...
               <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  اضافة </button>    <a href="<?=base_url('admin_panel/countries')?>" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
