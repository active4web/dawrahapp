                    ...
                    <div class="col-lg-8 col-md-10 col-12 mx-auto py-4 px-5 rounded form-wrap">
                        ...
                        <form class="password-form clearfix" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <label for="confirm-code" class="col-form-label text-center d-block mt-2">أدخل الرمز

                                    المكون من ستة أرقام هنا</label>

                                <input type="text" name="code"  class="form-control form-control-lg border-0 mt-4" id="confirm-code">
